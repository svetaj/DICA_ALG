...
public class PercolationStatsTest1
{
   private int np;
   private int tp;
   private double[] treshold;

   public PercolationStatsTest1(int N, int T)    // perform T independent computational
...
//   }
   ...
   public static void main(String[] args)   // test client, described below
   {
       int x = StdIn.readInt();
       int y = 1;
       PercolationStatsTest1 z = new PercolationStatsTest1(x, y);
